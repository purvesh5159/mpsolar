...
{/if}
<input type="hidden" class="stcigField" value="" />
<input type="hidden" class="stcTotalVal" value="" />
<input type="hidden" class="dpvalue" value="" />
		  ...
		  {if $MODULE eq 'Payment'}
            ...
            {else}
					<tr>
						...
						<td>
							<strong>{vtranslate('LBL_ASSIGNQTY',$MODULE)}</strong>
						</td>
						{/if}
