...
{strip}
<input type="hidden" name="assingeid" id="assingeid" class="assingeid" value='{$ASSIGNEDID}' />
<input type="hidden" name="currentedid" id="currentedid" class="currentedid" value='{$CURRENTID}' />
