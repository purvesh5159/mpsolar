<?php
/* Smarty version 3.1.39, created on 2024-02-01 05:50:41
  from 'D:\wamp\www\mpsolar\layouts\v7\modules\Vtiger\ModuleRelatedTabs.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_65bb3131c8c6b7_85948948',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b3d1a1abce7ef6161d0e044a20373e61b5a5a634' => 
    array (
      0 => 'D:\\wamp\\www\\mpsolar\\layouts\\v7\\modules\\Vtiger\\ModuleRelatedTabs.tpl',
      1 => 1688108359,
      2 => 'file',
    ),
  ),
...
function content_65bb3131c8c6b7_85948948 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
" <?php if ($_smarty_tpl->tpl_vars['RELATEDMODULENAME']->value == "ModComments") {?> title <?php } else {
if ($_smarty_tpl->tpl_vars['DETAILVIEWRELATEDLINKLBL']->value == 'Sales Orders') {?>title="Project"<?php } else { ?>title="<?php echo $_smarty_tpl->tpl_vars['DETAILVIEWRELATEDLINKLBL']->value;?>
"<?php }
...
" recordsCount="" ><?php if ($_smarty_tpl->tpl_vars['RELATEDMODULENAME']->value == "ModComments") {?><span class="tab-icon"><i class="fa fa-comment" style="font-size: 24px"></i></span><?php } else { ?><span class="tab-icon"><?php if ($_smarty_tpl->tpl_vars['DETAILVIEWRELATEDLINKLBL']->value == 'Sales Orders') {?><i class="vicon-project" style="font-size: 24px"></i><?php } else {
$_smarty_tpl->_assignInScope('RELATED_MODULE_MODEL', Vtiger_Module_Model::getInstance($_smarty_tpl->tpl_vars['RELATEDMODULENAME']->value));
