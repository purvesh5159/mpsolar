...
function content_65bb300c8f6216_36774622 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->_assignInScope('assignqty', ("assignqty").($_smarty_tpl->tpl_vars['row_no']->value));
...
$_smarty_tpl->_assignInScope('bankdetails', ("bankdetails").($_smarty_tpl->tpl_vars['row_no']->value));
$_smarty_tpl->_assignInScope('paymentmode', ("paymentmode").($_smarty_tpl->tpl_vars['row_no']->value));
$_smarty_tpl->_assignInScope('paymentdate', ("paymentdate").($_smarty_tpl->tpl_vars['row_no']->value));
$_smarty_tpl->_assignInScope('paymentnumber', ("paymentnumber").($_smarty_tpl->tpl_vars['row_no']->value));
...
" /></td><?php if ($_smarty_tpl->tpl_vars['MODULE']->value != 'Payment') {
if ($_smarty_tpl->tpl_vars['IMAGE_EDITABLE']->value) {?><td class='lineItemImage' style="text-align:center;"><img src='<?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['image']->value];?>
...
" name="<?php echo $_smarty_tpl->tpl_vars['paymentnumber']->value;?>
" type="text"  value="<?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['paymentnumber']->value];?>
...
" class="bankdetails lineItemCommentBox"><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['bankdetails']->value];?>
...
</span></span><?php }?></td><?php if ($_smarty_tpl->tpl_vars['MODULE']->value == 'SalesOrder') {?><td><input id="<?php echo $_smarty_tpl->tpl_vars['assignqty']->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars['assignqty']->value;?>
" type="text" class="assignqty smallInputBox inputElement"data-rule-required=true data-rule-positive=true data-rule-greater_than_zero=true value="<?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['assignqty']->value])) {
echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['assignqty']->value];
} else { ?>1<?php }?>"<?php if ($_smarty_tpl->tpl_vars['QUANTITY_EDITABLE']->value == false) {?> disabled=disabled <?php }?> /></td><?php }
}
if ($_smarty_tpl->tpl_vars['PURCHASE_COST_EDITABLE']->value) {?><td><input id="<?php echo $_smarty_tpl->tpl_vars['purchaseCost']->value;?>
" type="hidden" value="<?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['purchaseCost']->value]) {
echo ((float)$_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['purchaseCost']->value])/((float)$_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value]);
...
echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['purchaseCost']->value];
} else { ?>0<?php }?></span></td><?php }?><td><div><input id="<?php echo $_smarty_tpl->tpl_vars['listPrice']->value;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></table></div><?php }?></div></span></td><td><div id="productTotal<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
