...
function getConvertSalesOrderToMaintance($focus,$so_focus,$soid)
{
	...
	$focus->column_fields['contactname'] = $so_focus->column_fields['contact_id'];//to include contact name in Invoice
	$focus->column_fields['mobileno'] = $so_focus->column_fields['mobileno'];
