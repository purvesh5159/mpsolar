...
class Installteam extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_installteam';
	var $table_index= 'installteamid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_installteamcf', 'installteamid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_installteam', 'vtiger_installteamcf');
	...
	var $related_tables = Array( 
					'vtiger_installteamcf' => Array('installteamid')
					);
	...
	var $tab_name_index = Array(
		...
		'vtiger_installteam'   => 'installteamid',
	    'vtiger_installteamcf' => 'installteamid');
	...
	var $list_fields = Array (
		...
		'Installteam No' => Array('installteam', 'installteamno'),
/*'Installteam No'=> Array('installteam', 'installteamno'),*/
		'Assigned To' => Array('crmentity','smownerid')
	);
	var $list_fields_name = Array (
		/* Format: Field Label => fieldname */
		'Installteam No' => 'installteamno',
/*'Installteam No'=> 'installteamno',*/
		'Assigned To' => 'assigned_user_id'
	);

	// Make the field link to detail view
	var $list_link_field = 'installteamno';
...
/*'Installteam No'=> 'installteamno',*/
	...
	var $popup_fields = Array ('installteamno');

	// For Alphabetical search
	var $def_basicsearch_col = 'installteamno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'installteamno';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('installteamno','assigned_user_id');

	var $default_order_by = 'installteamno';
	...
	*/
	function vtlib_handler($moduleName, $eventType) {
		global $adb;
 		if($eventType == 'module.postinstall') {
			...
			Installteam::checkWebServiceEntry();
			Installteam::createUserFieldTable($moduleName);
			Installteam::addInTabMenu($moduleName);
	...
	static function checkWebServiceEntry() {
		...
		$sql       =  "SELECT count(id) AS cnt FROM vtiger_ws_entity WHERE name = 'Installteam'";
		...
		if($adb->num_rows($result) > 0)
		{
			...
			if($no == 0)
			{
				...
				$ws_entitySql = "INSERT INTO vtiger_ws_entity ( id, name, handler_path, handler_class, ismodule ) VALUES".
						  " (?, 'Installteam','include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation' , 1)";
