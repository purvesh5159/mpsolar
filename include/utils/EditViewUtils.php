...
function getConvertQuotesToProjectInvoice($focus,$so_focus,$soid)
{
	...
	$focus->column_fields['housetype'] = $so_focus->column_fields['housetype'];
	$focus->column_fields['rooftype'] = $so_focus->column_fields['rooftype'];
	$focus->column_fields['meterphase'] = $so_focus->column_fields['meterphase'];
	$focus->column_fields['roofangle'] = $so_focus->column_fields['roofangle'];
	$focus->column_fields['dnsp'] = $so_focus->column_fields['dnsp'];
	$focus->column_fields['meterapproval'] = $so_focus->column_fields['meterapproval'];
	$focus->column_fields['retailer'] = $so_focus->column_fields['retailer'];
	$focus->column_fields['afterinstallapp'] = $so_focus->column_fields['afterinstallapp'];
	$focus->column_fields['nmi'] = $so_focus->column_fields['nmi'];
	$focus->column_fields['isoffpick'] = $so_focus->column_fields['isoffpick'];
...
function getConvertSalesOrderToMaintance($focus,$so_focus,$soid)
{
	...
	$focus->column_fields['maintenance_tks_subject'] = $so_focus->column_fields['subject'];
	$focus->column_fields['maintenance_tks_quotename'] = $so_focus->column_fields['quote_id'];
	$focus->column_fields['maintenance_tks_projectdate'] = $so_focus->column_fields['projectdate'];
	$focus->column_fields['maintenance_tks_duedate'] = $so_focus->column_fields['duedate'];
	$focus->column_fields['maintenance_tks_contactname'] = $so_focus->column_fields['contact_id'];//to include contact name in Invoice
	$focus->column_fields['maintenance_tks_mobileno'] = $so_focus->column_fields['mobileno'];
	$focus->column_fields['maintenance_tks_primaryemail'] = $so_focus->column_fields['email'];
	$focus->column_fields['exciseduty'] = $so_focus->column_fields['exciseduty'];
	$focus->column_fields['salescommission'] = $so_focus->column_fields['salescommission'];
	$focus->column_fields['bill_street'] = $so_focus->column_fields['bill_street'];
	$focus->column_fields['ship_street'] = $so_focus->column_fields['ship_street'];
...
function getAssociatedProducts($module, $focus, $seid = '', $refModuleName = false)
{
	...
	for($i=1;$i<=$num_rows;$i++)
	{
		...
		$assignqty=$adb->query_result($result,$i-1,'assignqty');
		...
		$product_Detail[$i]['assignqty'.$i]=decimalFormat($assignqty);
