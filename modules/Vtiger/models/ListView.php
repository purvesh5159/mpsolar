...
class Vtiger_ListView_Model extends Vtiger_Base_Model {
	...
	public function getListViewEntries($pagingModel) {
        ...
        $currentUserModel = Users_Record_Model::getCurrentUserModel();
		$isAdminUser = $currentUserModel->isAdminUser();
		...
		if($moduleName == 'Leads' && $isAdminUser != 1){
			$listQuery = $this->getQuery();
			$listQuery	= str_replace("SELECT vtiger_crmentity.description, vtiger_leaddetails.firstname, vtiger_leaddetails.lastname, vtiger_leadaddress.mobile, vtiger_leaddetails.email, vtiger_leaddetails.leadstatus, vtiger_leaddetails.leadsource, vtiger_leaddetails.followupdate, vtiger_crmentity.smownerid","
				  	 SELECT vtiger_leaddetails.firstname, vtiger_leaddetails.lastname,vtiger_leadaddress.mobile,vtiger_crmentity.smownerid",$listQuery);
		}
		else{
		$listQuery = $this->getQuery();
	     }
